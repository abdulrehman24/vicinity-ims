    ...
    public function feed()
    {
        ...
        foreach ($bookings as $booking) {
            ...
            foreach ($sortedCategories as $cat) {
                ...
                $equipmentDisplay .= "[" . strtoupper($cat) . "]\n";
            ...
            $eventLines = [
                'BEGIN:VEVENT',
                'UID:'.$booking->id.'-'.md5($createdUtc).'@ims.vicinity.sg', // Busting UID cache
                ...
                'LOCATION:'.$location,
                'STATUS:'.$icsStatus,
                'SEQUENCE:1', // Increasing sequence
                'TRANSP:OPAQUE',
                'END:VEVENT',
            ];
        ...
        $icsHeader = [
            ...
            'X-WR-CALDESC:Equipment deployment and returns for Vicinity Studio',
